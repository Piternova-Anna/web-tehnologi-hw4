  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$telNumber;?></p>
          <hr>
    ...
    <?=$skills[$i]["persent"];?>%
        ...
        <?php }?>
          ...
          <div class="w3-light-grey w3-round-xlarge w3-small">
          <div class="w3-container w3-center w3-round-xlarge w3-teal" 			style="width:<?=$languages[$i]["persent"];?>%">
    <?=$languages[$i]["persent"];?>%
   			 </div>
          </div>
         <?php }?>
    ...
    <div class="w3-twothird">
      ...
      <?php for ($i = 0 ; $i < count($experience); $i++) {?> 
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$experience[$i]["start date"];?>-<?=$experience[$i]["end date"];?></h6>
